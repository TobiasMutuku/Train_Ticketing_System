            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="library/sample.png" class="page-scroll">
                                <h3>Map</h3>
                            </a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Hawk Railways, Hawk Railways, Hawk Railways"></span></h1>

                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Online Reservation, Online Reservation, Online Reservation"></span>
                            </h1>

                            <p class="main-heading-text">WELCOME TO,<br />HAWK   E - TICKETING RAILWAYS</p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title">Hawk Railway Co. Contact List</h1>

                            <p class="main-heading-text">The Hawk Railway Corporation is 32 years old and it runs a
                                unilaterally designed track system of 1067mm cape gauge. Only 30km of its track
                                distribution is in double track and that is within Nairobi area.
                                <br />The Hawk railway narrow gauge network is approximately 3,500 km long and is
                                currently being extended by a narrow gauge line between Naivasha and the Lamu - Port
                                Kilindini line and a 2375 km long standard gauge line between Malindi – Nairobi – Malaba.
                            </p>
